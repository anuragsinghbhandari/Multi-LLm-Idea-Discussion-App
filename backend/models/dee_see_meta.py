...
prompt = ChatPromptTemplate.from_messages(
    ...
    ('human', 'Now your turn and word limit is 100 words, **Behave strictly according to your profession** and **and answer in a single paragraph** and **neither write your name nor profession in the answer**.')
    ]
)
